...
const CHECK_NOTES = {
  "Face Verification": "Ensures document owner matches the presented individual.",
};
...
function App() {
  ...
  const clearHistory = () => setHistory(emptyHistory);
        ...
        <main className="dashboard-main">
          ...
          <section className="system-overview">
            ...
            <StatCard
              ...
              note="MANUAL REVIEW"
              tone="yellow"
              title="Screenings where at least one check (e.g. photo replacement, stamp forgery, face verification) came back REVIEW instead of PASS — an officer must manually inspect these."
            />
            <StatCard
              label="HIGH RISK"
              ...
              note="FLAGGED"
              tone="red"
              title="Screenings where the AI risk engine returned a HIGH risk level — the strongest signal of a forged or mismatched document."
            />
          </section>
